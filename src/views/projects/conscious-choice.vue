<template>
    ...
    <div class="wrapper">
        ...
        <p>Additionally, to the changes on the product page, we increased the sustainability scores <strong>visibility in the Product Summary</strong> by placing it directly under the product image with color highlights to catch attention.</p>
        ...
        <p>In the high-fidelity prototype, we covered new features, to solve as many user stories as possible. This also includes features that are not specifically linked to the sustainability of the product, but just online shop functionality, that a user would expect for the solution to be able to compete with bigger e-commerce platforms.</p>
